    ...
    <a-layout-header class="a-head">
      ...
      >
        <a-form
          ...
          :layout="layout"
        >
          <a-form-item label="旧密码" name="oldpass" has-feedback>
          ...
          <a-form-item label="新密码" name="newpass" has-feedback>
          ...
          <a-form-item label="确认新密码" name="dbnewpass" has-feedback>
      ...
      <a-row style="height: 100%">
        <a-col :span="8" class="a-item">
          ...
          <left-circle-two-tone
            ...
            class="color size trigger"
          />
          <a-typography-title class="color" :level="3"
            >学员成绩管理系统</a-typography-title
          >
        </a-col>
        <a-col :span="8" class="a-item">
...
const form = ref<any>({});
const checkpasscommon = async (_rule: Rule, value: string) => {
  // dbnewpass
